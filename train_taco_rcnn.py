...
if __name__ == '__main__':
    ...
    # Path to dataset
    train_json_file = './datasets/taco_split/annotations/coco_annotations_train.json'
    train_img_dir = './datasets/taco_split/images/train'
    val_json_file = './datasets/taco_split/annotations/coco_annotations_val.json'
    val_img_dir = './datasets/taco_split/images/val'
